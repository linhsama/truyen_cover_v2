<div class="main-add">
    <h3 class="section-title">Thêm chapter</h3>
    <form class="form-group" action="pages/chapter/action.php?req=add" method="post" enctype="multipart/form-data">
        <input type="hidden" class="form-control" id="truyen_id" name="truyen_id" required value="<?= $truyen_id ?>" readonly>

        <div class="col">
            <label for="chapter_ten" class="form-label">Tên chapter</label>
            <input type="text" class="form-control" id="chapter_ten" name="chapter_ten" required>
        </div>
        <div class="col">

...
$truyen__Get_User_Paged = $truyen->Truyen__Get_User_Paged($page_number, $tai_khoan_id, 1);
?>
...
<main class="main">
    <div class="main-container">
        <div class="main-title-container">
            <a href="index.php?pages=truyen-da-xem">
                <div class="item-title color-1"><i class='bx bx-star bx-tada'></i>TRUYỆN ĐÃ XEM
        ...
        <div class="main-item-container">
            ...
            <a href="index.php?pages=trang-chu">
                <div class="manga-title color-1 m-3">Bạn chưa xem truyện nào
                </div>
            </a>
            <?php endif ?>
        </div>
    ...
    <div class="pagination-container">
        <div class="pagination">
            ...
            if ($page_number > 1) {
                echo '<a href="index.php?pages=truyen-da-xem&page=1" class="pagination-link">Đầu trang</a>';
            }

            // Hiển thị nút trước
            if ($page_number > 1) {
                echo '<a href="index.php?pages=truyen-da-xem&page=' . ($page_number - 1) . '" class="pagination-link">Trang trước</a>';
            }

            // Hiển thị các trang gần đó
            for ($i = max(1, $page_number - 2); $i <= min($page_number + 2, $total_pages); $i++) {
                echo '<a href="index.php?pages=truyen-da-xem&page=' . $i . '" class="pagination-link ' . ($page_number == $i ? 'active' : '') . '">' . $i . '</a>';
            }

            // Hiển thị nút sau
            if ($page_number < $total_pages) {
                echo '<a href="index.php?pages=truyen-da-xem&page=' . ($page_number + 1) . '" class="pagination-link">Trang sau</a>';
            }

            // Hiển thị nút cuối trang
            if ($page_number < $total_pages) {
                echo '<a href="index.php?pages=truyen-da-xem&page=' . $total_pages . '" class="pagination-link">Cuối trang</a>';
            }
            ?>
        </div>
    </div>
